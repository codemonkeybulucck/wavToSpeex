...
-(void)initAudio {
    ///设置音频参数
    audioDescription.mSampleRate = (int)[SAMPLE_RATE integerValue];//采样率
    audioDescription.mFormatID = kAudioFormatLinearPCM;
    audioDescription.mFormatFlags = kLinearPCMFormatFlagIsSignedInteger | kAudioFormatFlagIsPacked;
    audioDescription.mChannelsPerFrame = (int)[CHANNEL integerValue];///单声道
    audioDescription.mFramesPerPacket = 1;//每一个packet一侦数据
    audioDescription.mBitsPerChannel = (int)[BIT_DEPTH integerValue];//每个采样点16bit量化
